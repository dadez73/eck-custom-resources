...
type ProjectConfig struct {
	...
	// spec defines the desired state of ProjectConfig
	// +required
	Spec ProjectConfigSpec `json:"spec"`

	// status defines the observed state of ProjectConfig
	// +optional
	Status ProjectConfigStatus `json:"status,omitempty,omitzero"`
}
